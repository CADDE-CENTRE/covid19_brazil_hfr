...
################################################################################
# The SIVEP dataset is split by epiyear (based on Date of first Symptom column)
# For our interests, we only need to download srag-2020 and srag-2021.
# For details on the link to the csv, look at:

# https://opendatasus.saude.gov.br/dataset/srag-2020
# https://opendatasus.saude.gov.br/dataset/srag-2021-e-2022

#
RELEASE_DATE_i = '31-01-2022'
print(RELEASE_DATE_i)
options(timeout = 60*60)

# 2020 release
url=paste0('https://d26692udehoye.cloudfront.net/SRAG/2020/INFLUD20-',RELEASE_DATE_i,'.csv')
dest = paste0(sivepdir, "INFLUD20-", RELEASE_DATE_i, ".csv")
download.file(url, dest)

# 2021 release
url=paste0('https://d26692udehoye.cloudfront.net/SRAG/2021/INFLUD21-',RELEASE_DATE_i,'.csv')
dest = paste0(sivepdir, "INFLUD21-", RELEASE_DATE_i, ".csv")
download.file(url, dest)
...
SIVEP_ORIGINAL20 <- paste0(sivepdir, "INFLUD20-",RELEASE_DATE_i,".csv")
...
df_sivep_AM_filtered = subset(df_sivep_AM_filtered, (DateICUstart < dmy("11-12-2022")) | (is.na(DateICUstart)))
df_sivep_AM_filtered = subset(df_sivep_AM_filtered, (DateICUend < dmy("11-12-2022")) | (is.na(DateICUend)))
df_sivep_AM_filtered = subset(df_sivep_AM_filtered, (DateAdmission < dmy("11-12-2022")) | (is.na(DateAdmission)))
df_sivep_AM_filtered = subset(df_sivep_AM_filtered, (DateDeath < dmy("11-12-2022")) | (is.na(DateDeath)))
df_sivep_AM_filtered = subset(df_sivep_AM_filtered, (DateSymptoms < dmy("11-12-2022")) | (is.na(DateSymptoms)))
