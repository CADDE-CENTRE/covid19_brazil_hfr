...
m_fit <- m$sample( 
		data=stan_data, seed=42,
		refresh=1e2, iter_warmup=5e2, iter_sampling=50e3, chains=4,
		parallel_chains=4, threads_per_chain = 1, save_warmup=FALSE,
		thin=4, # New argument to avoid memory issues
