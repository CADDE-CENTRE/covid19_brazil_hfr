...
{			
	...
	args$source_dir= '/rds/general/user/or105/home/libs/covid19.P1.IFR/inst'
	args$preproc_file= 'scripts/preprocessing.210719d2.R'
	args$cmdstan_file= 'scripts/HFR.fit.210719d.cmdstan.R'
	args$postproc_oneloc_file = 'scripts/HFR.postprocessing.oneloc.210719.R'
	args$postproc_allloc_file = 'scripts/HFR.postprocessing.allloc.210719.R'
...
{	
  loc_labels <- c('belo-horizonte','curitiba', "florianopolis", "goiania", "joao-pessoa", "macapa", 'manaus', "natal", 'porto-alegre', "porto-velho", 'rio-de-janeiro', 'salvador', 'sao-paulo', "sao-luis")
  # loc_labels <- 'sao-paulo'
  
  args <- list()	
  args$stanmodel = 'age_hfr_210719d.stan'
  args$source_dir= '/rds/general/user/ab1820/home/git/covid19.P1.IFR/inst'
  args$preproc_file= 'scripts/preprocessing.210719h2.R'
  args$cmdstan_file= 'scripts/HFR.fit.210719d.cmdstan.R'
  args$postproc_oneloc_file = 'scripts/HFR.postprocessing.oneloc.210719.R'
  args$postproc_allloc_file = 'scripts/HFR.postprocessing.allloc.210719.R'
  args$postproc_knit_rmd = 'scripts/HFR.postprocessing.knit.report.R'
...
{			
  ...
  args$stanmodel = 'age_hfr_210719d.stan' 
  args$source_dir= '/rds/general/user/cw1716/home/covid19.P1.IFR/inst'  
  args$preproc_file= 'scripts/preprocessing.210719h2.R'
  args$cmdstan_file= 'scripts/HFR.fit.210619d.cmdstan.R'
...
########################################
pbshead <- make.PBS.header(	hpc.walltime=32, 
		hpc.select=1, 
		hpc.nproc=4, 
		hpc.mem= "48gb", 
...
#	prepare PBS header for cmdstan run and post processing for that location
########################################
pbshead <- make.PBS.header(	hpc.walltime=13, 
		hpc.select=1, 
		hpc.nproc=4, 
		hpc.mem= "48gb", 
		hpc.load= "module load anaconda3/personal\nsource activate covid19.P1.IFR\nexport TBB_CXX_TYPE=gcc\nexport CXXFLAGS+=-fPIE", 
